  ...
  return (
    <Sidebar className="border-r border-border bg-background">
      <SidebarHeader className="flex flex-col gap-8 p-8 pb-4">
        ...
        <Link href="/dashboard/create-mock" className="w-full flex items-center justify-center bg-foreground text-background text-sm font-medium px-4 py-3.5 rounded-lg shadow-sm hover:shadow-md hover:-translate-y-px active:translate-y-0 transition-all duration-150 cursor-pointer">
